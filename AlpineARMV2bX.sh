...
echo -e "${green}你选择了安装V2bX${plain}"
        ...
        wget -P /etc/V2bX https://github.com/wyx2685/V2bX/releases/download/v0.0.0-20240122/V2bX-linux-arm64-v8a.zip
        unzip /etc/V2bX/V2bX-linux-arm64-v8a.zip -d /etc/V2bX
